...
def plot_optimal_sizes_vs_loadcapex(results,highlight_load_capex=None):
    """
    ...
    # NEW: highlight vertical line if requested
    if highlight_load_capex is not None:
        ax1.axvline(highlight_load_capex, color="red", linestyle="--", linewidth=1.5)
...
def plot_LCOE_vs_utilization(results,highlight_load_capex=None):
    """
...
def plot_LCOE_and_utilization_vs_loadcapex(results,highlight_load_capex=None):
    """
